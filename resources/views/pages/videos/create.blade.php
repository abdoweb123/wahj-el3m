...
{{--                        <form action="{{route('video_store')}}" method="post" enctype="multipart/form-data" name="myForm" onsubmit="return validateForm()">--}}
                        <form action="{{route('video_store')}}" method="post" enctype="multipart/form-data" name="myForm">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input id="name" type="text" name="name" class="form-control" placeholder="الجزء الاول" value="{{old('name')}}" required>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col">
                                    <label class="mr-sm-2"> قم برفع الفيديو :</label>
                                    <div id="upload-container" class="text-center">
                                        <input id="browseFile" class="btn btn-primary" value="اختر فيديو">
